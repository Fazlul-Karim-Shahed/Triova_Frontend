        ...
        <div className="mx-auto bg-white rounded pt-6 pb-8 mb-4">
            ...
            <form className="space-y-6" onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="grid md:grid-cols-3 gap-5 pt-6 space-y-2">
                    ...
                    <div>
                        <label className="font-bold block text-gray-700 mb-1">Delivery Method</label>
                        <select required name="deliveryMethod" value={formData.deliveryMethod} onChange={handleChange} className="w-full p-2 border rounded focus:ring focus:ring-green-200">
                            <option value="">Select Delivery Method</option>
                            {courier.map((courier) => (
                                <option value={courier._id}>{courier.name}</option>
                            ))}
                        </select>
                    </div>
