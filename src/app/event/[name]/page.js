    ...
    return (
        <section className="py-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white to-gray-100 min-h-screen">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl mb-10 relative group">
                <ClientImageWithLoader src={event.promotionalImage?.secure_url} alt={event.name} className="w-full h-80 object-cover transition-transform group-hover:scale-105 duration-700" />
