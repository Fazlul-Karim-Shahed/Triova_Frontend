...
const navItems = [
    { label: "Dashboard", href: "/promoter/dashboard", icon: faTachometerAlt },
    { label: "Profile", href: "/promoter/dashboard/profile", icon: faPerson },
    { label: "Promo", href: "/promoter/dashboard/promo", icon: faTag },
    { label: "Orders", href: "/promoter/dashboard/order", icon: faBagShopping },
];
            ...
            <div className="grid grid-cols-12">
                ...
                <div className="hidden md:block col-span-2 p-5">
                    <div className="sticky top-5 bg-white/80 backdrop-blur-2xl rounded-3xl shadow-xl border border-emerald-100 p-4">
                        <h2 className="text-xl font-bold text-center text-emerald-700 mb-6">Access Panel</h2>
                        {navItems.map((item) => (
