            ...
            <div>
                ...
                <div className='md:hidden top-1 mx-3'>
                    ...
                    <div className={`m-2 py-4  bg-green-100 rounded-lg text-green-800 ${open ? 'block' : 'hidden'}`}>
                        <Link onClick={() => setOpen(!open)} href='/admin/dashboard/product' className='block m-4 hover:underline'> <FontAwesomeIcon icon={faBookOpenReader} className='fas fa-lg me-4 text-green-800' />Product</Link>
                ...
                <div className='grid grid-cols-12 gap-5'>
                    ...
                    <div className='col-span-2 px-3 py-4 bg-green-100 rounde-e-md hidden md:block'>
                        <Link href='/admin/dashboard/product' className='block m-4 hover:underline'> <FontAwesomeIcon icon={faBookOpenReader} className='fas fa-lg me-4 text-green-800' />Product</Link>
                    </div>
