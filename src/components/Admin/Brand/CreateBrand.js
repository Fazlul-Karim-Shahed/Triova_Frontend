...
import { createBrandApi } from '@/src/api/SuperAdminApi/BrandApi';

export default function CreateBrand({ category }) {
  ...
  return (
      <div className="mx-auto bg-white rounded pt-6 pb-8 mb-4">
          ...
          <h1 className="text-2xl text-center mb-2">Create Brand for Department -  <span className='text-blue-600'>{category.departmentId.name}</span></h1>
