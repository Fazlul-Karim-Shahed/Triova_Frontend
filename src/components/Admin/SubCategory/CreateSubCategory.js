...
import { createSubCategoryApi } from "@/src/api/SuperAdminApi/SubCategoryApi";
...
const CreateSubCategory = ({ category }) => {
    ...
    const handleSubmit = (e) => {
        ...
        createSubCategoryApi(formData).then((data) => {
    ...
    return (
        <div className=" mx-auto bg-white rounded-lg mb-10">
            <h2 className="text-3xl font-semibold mb-8">Create Sub Category For {category.name} </h2>
